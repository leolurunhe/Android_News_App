...
public class PoliticsPageRecyclerViewAdapter extends RecyclerView.Adapter<PoliticsPageRecyclerViewAdapter.ViewHolder> {
    private List<NewsItem> ITEMS;
    private PoliticsPageRecyclerViewAdapter.OnPoliticsPageFragmentListener mListener;
    private Context mContext;
    private final String FAV_FILE = "favorite_news";

    PoliticsPageRecyclerViewAdapter(List<NewsItem> items, PoliticsPageRecyclerViewAdapter.OnPoliticsPageFragmentListener listener, Context context){
        this.ITEMS = items;
    ...
    @NonNull
    @Override
    public PoliticsPageRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.news_item_row, parent, false);
        return new PoliticsPageRecyclerViewAdapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final PoliticsPageRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onPoliticsPageItemClickListener(holder.mItem);
            }
        });
        ...
        holder.mView.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View v){
                mListener.onPoliticsPageItemLongClickListener(holder.mItem);
                return false;
            }
        });
    }
    ...
    public interface OnPoliticsPageFragmentListener{
        void onPoliticsPageItemClickListener(NewsItem item);
        void onPoliticsPageItemLongClickListener(NewsItem item);
    }
