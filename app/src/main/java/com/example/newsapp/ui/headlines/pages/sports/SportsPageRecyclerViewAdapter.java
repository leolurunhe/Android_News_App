...
public class SportsPageRecyclerViewAdapter extends RecyclerView.Adapter<SportsPageRecyclerViewAdapter.ViewHolder> {
    private List<NewsItem> ITEMS;
    private Context mContext;
    private final String FAV_FILE = "favorite_news";
    private SportsPageRecyclerViewAdapter.OnSportsPageFragmentListener mListener;

    SportsPageRecyclerViewAdapter(List<NewsItem> items, SportsPageRecyclerViewAdapter.OnSportsPageFragmentListener listener, Context context){
        ITEMS = items;
        mListener = listener;
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onSportsPageItemClickListener(holder.mItem);
            }
        });
        ...
        holder.mView.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View v){
                mListener.onSportsPageItemLongClickListener(holder.mItem);
                return false;
            }
        });
    }
    ...
    public interface OnSportsPageFragmentListener{
        void onSportsPageItemClickListener(NewsItem item);
        void onSportsPageItemLongClickListener(NewsItem item);
    }
