package com.example.newsapp.ui.headlines.pages.sports;
 ...
 * Use the {@link SportsPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SportsPageFragment extends Fragment implements SportsPageRecyclerViewAdapter.OnSportsPageFragmentListener{
    ...
    private SportsPageRecyclerViewAdapter mAdapter;
    private SportsPageRecyclerViewAdapter.OnSportsPageFragmentListener itemListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_sports_page, container, false);
        progressbar_view = root.findViewById(R.id.progressbar_view);
        mAdapter = new SportsPageRecyclerViewAdapter(mItems, itemListener, getActivity());
        RecyclerView recyclerView = root.findViewById(R.id.sports_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        recyclerView.setAdapter(mAdapter);
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_sports);
    ...
    @Override
    public void onSportsPageItemClickListener(NewsItem item) {
    ...
    @Override
    public void onSportsPageItemLongClickListener(final NewsItem item) {
    ...
    private void initData() {
        String url = getString(R.string.sportsPageUrl);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    RecyclerView sportsView = requireActivity().findViewById(R.id.sports_recycler_view);
                    if(progressbar_view.getVisibility() == View.VISIBLE){
                        progressbar_view.setVisibility(View.GONE);
                    }
                    sportsView.setVisibility(View.VISIBLE);
