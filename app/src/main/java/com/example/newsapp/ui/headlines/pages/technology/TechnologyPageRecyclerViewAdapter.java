...
public class TechnologyPageRecyclerViewAdapter extends RecyclerView.Adapter<TechnologyPageRecyclerViewAdapter.ViewHolder> {
    private List<NewsItem> ITEMS;
    private Context mContext;
    private final String FAV_FILE = "favorite_news";
    private TechnologyPageRecyclerViewAdapter.OnTechnologyPageFragmentListener mListener;
    TechnologyPageRecyclerViewAdapter(List<NewsItem> items, TechnologyPageRecyclerViewAdapter.OnTechnologyPageFragmentListener listener, Context context){
        ITEMS = items;
        mListener = listener;
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onTechnologyPageItemClickListener(holder.mItem);
            }
        });
        ...
        holder.mView.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View v){
                mListener.onTechnologyPageItemLongClickListener(holder.mItem);
                return false;
            }
        });
    }
    ...
    public interface OnTechnologyPageFragmentListener{
        void onTechnologyPageItemClickListener(NewsItem item);
        void onTechnologyPageItemLongClickListener(NewsItem item);
    }
