package com.example.newsapp.ui.headlines.pages.politics;
 ...
 * Use the {@link PoliticsPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PoliticsPageFragment extends Fragment implements PoliticsPageRecyclerViewAdapter.OnPoliticsPageFragmentListener {
    private List<NewsItem> mItems;
    private RequestQueue queue;
    private File file;
    private PoliticsPageRecyclerViewAdapter.OnPoliticsPageFragmentListener itemListener;
    private final String FAV_FILE = "favorite_news";
    private PoliticsPageRecyclerViewAdapter mAdapter;
    private SwipeRefreshLayout swipeRefreshLayout;
    private LinearLayout progressbar_view;

    public PoliticsPageFragment() {
        // Required empty public constructor
    }


    private static PoliticsPageFragment newInstance() {
        return new PoliticsPageFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_politics_page, container, false);
        progressbar_view = root.findViewById(R.id.progressbar_view);
        mAdapter = new PoliticsPageRecyclerViewAdapter(mItems, itemListener, getActivity());
        RecyclerView recyclerView = root.findViewById(R.id.politics_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        recyclerView.setAdapter(mAdapter);
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_politics);
    ...
    @Override
    public void onPoliticsPageItemClickListener(NewsItem item) {
    ...
    @Override
    public void onPoliticsPageItemLongClickListener(final NewsItem item) {
    ...
    private void initData() {
        String url = getString(R.string.politicsPageRul);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    RecyclerView politicsView = requireActivity().findViewById(R.id.politics_recycler_view);
