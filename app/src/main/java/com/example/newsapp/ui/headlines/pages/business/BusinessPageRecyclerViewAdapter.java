package com.example.newsapp.ui.headlines.pages.business;
...
public class BusinessPageRecyclerViewAdapter extends RecyclerView.Adapter<BusinessPageRecyclerViewAdapter.ViewHolder> {
    private List<NewsItem> ITEMS;
    private BusinessPageRecyclerViewAdapter.OnBusinessPageFragmentListener mListener;
    private Context mContext;
    private final String FAV_FILE = "favorite_news";

    BusinessPageRecyclerViewAdapter(List<NewsItem> items, BusinessPageRecyclerViewAdapter.OnBusinessPageFragmentListener listener, Context context){
        this.ITEMS = items;
    ...
    @NonNull
    @Override
    public BusinessPageRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.news_item_row, parent, false);
        return new BusinessPageRecyclerViewAdapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final BusinessPageRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onBusinessPageItemClickListener(holder.mItem);
            }
        });
        ...
        holder.mView.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View v){
                mListener.onBusinessPageItemLongClickListener(holder.mItem);
                return false;
            }
        });
    }
    ...
    public interface OnBusinessPageFragmentListener{
        void onBusinessPageItemClickListener(NewsItem item);
        void onBusinessPageItemLongClickListener(NewsItem item);
    }
