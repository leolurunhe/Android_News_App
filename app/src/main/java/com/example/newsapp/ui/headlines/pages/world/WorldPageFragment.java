package com.example.newsapp.ui.headlines.pages.world;
 ...
 * Use the {@link WorldPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WorldPageFragment extends Fragment implements WorldPageRecyclerViewAdapter.OnWorldPageFragmentListener {
    private List<NewsItem> mItems;
    private RequestQueue queue;
    private File file;
    private WorldPageRecyclerViewAdapter.OnWorldPageFragmentListener itemListener;
    private final String FAV_FILE = "favorite_news";
    private WorldPageRecyclerViewAdapter mAdapter;
    ...
    private static WorldPageFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_world_page, container, false);
        LinearLayout progressbar_view = root.findViewById(R.id.progressbar_view);
        mAdapter = new WorldPageRecyclerViewAdapter(mItems, itemListener, getActivity());
        RecyclerView recyclerView = root.findViewById(R.id.world_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        recyclerView.setAdapter(mAdapter);
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_world);
    ...
    @Override
    public void onWorldPageItemClickListener(NewsItem item) {
    ...
    @Override
    public void onWorldPageItemLongClickListener(final NewsItem item) {
    ...
    private void initData() {
        String url = getString(R.string.worldPageUrl);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    RecyclerView worldView = requireActivity().findViewById(R.id.world_recycler_view);
