...
public class WorldPageRecyclerViewAdapter extends RecyclerView.Adapter<WorldPageRecyclerViewAdapter.ViewHolder> {
    public List<NewsItem> ITEMS;
    private OnWorldPageFragmentListener mListener;
    private Context mContext;
    private final String FAV_FILE = "favorite_news";

    WorldPageRecyclerViewAdapter(List<NewsItem> items, OnWorldPageFragmentListener listener, Context context){
        this.ITEMS = items;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onWorldPageItemClickListener(holder.mItem);
            }
        });
        ...
        holder.mView.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View v){
                mListener.onWorldPageItemLongClickListener(holder.mItem);
                return false;
            }
        });
    }
    ...
    public interface OnWorldPageFragmentListener{
        void onWorldPageItemClickListener(NewsItem item);
        void onWorldPageItemLongClickListener(NewsItem item);
    }
