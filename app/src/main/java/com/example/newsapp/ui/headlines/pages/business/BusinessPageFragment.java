 ...
 * Use the {@link BusinessPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BusinessPageFragment extends Fragment implements BusinessPageRecyclerViewAdapter.OnBusinessPageFragmentListener{
    private List<NewsItem> mItems;
    private RequestQueue queue;
    private File file;
    private BusinessPageRecyclerViewAdapter.OnBusinessPageFragmentListener itemListener;
    private final String FAV_FILE = "favorite_news";
    private BusinessPageRecyclerViewAdapter mAdapter;
    ...
    private static BusinessPageFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new BusinessPageRecyclerViewAdapter(mItems, itemListener, getActivity());
        RecyclerView recyclerView = root.findViewById(R.id.business_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        recyclerView.setAdapter(mAdapter);
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_business);
    ...
    @Override
    public void onBusinessPageItemClickListener(NewsItem item) {
    ...
    @Override
    public void onBusinessPageItemLongClickListener(final NewsItem item) {
    ...
    private void initData() {
        String url = getString(R.string.businessPageUrl);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    RecyclerView businessView = requireActivity().findViewById(R.id.business_recycler_view);
