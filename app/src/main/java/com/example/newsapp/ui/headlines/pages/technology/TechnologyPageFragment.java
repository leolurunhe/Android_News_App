package com.example.newsapp.ui.headlines.pages.technology;
 ...
 * Use the {@link TechnologyPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TechnologyPageFragment extends Fragment implements TechnologyPageRecyclerViewAdapter.OnTechnologyPageFragmentListener {
    ...
    private TechnologyPageRecyclerViewAdapter mAdapter;
    private TechnologyPageRecyclerViewAdapter.OnTechnologyPageFragmentListener itemListener;

    public TechnologyPageFragment() {
        // Required empty public constructor
    }


    private static Fragment newInstance() {
        return new TechnologyPageFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_technology_page, container, false);
        progressbar_view = root.findViewById(R.id.progressbar_view);
        mAdapter = new TechnologyPageRecyclerViewAdapter(mItems, itemListener, getActivity());
        RecyclerView recyclerView = root.findViewById(R.id.technology_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        recyclerView.setAdapter(mAdapter);
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_technology);
    ...
    @Override
    public void onTechnologyPageItemClickListener(NewsItem item) {
    ...
    @Override
    public void onTechnologyPageItemLongClickListener(final NewsItem item) {
    ...
    private void initData() {
        String url = getString(R.string.techPageUrl);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    RecyclerView technologyView = requireActivity().findViewById(R.id.technology_recycler_view);
