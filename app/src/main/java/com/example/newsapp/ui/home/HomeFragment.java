 ...
 * interface.
 */
public class HomeFragment extends Fragment implements HomeRecyclerViewAdapter.onHomeItemListener{
    private final String FAV_FILE = "favorite_news";
    private HomeRecyclerViewAdapter myAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RequestQueue queue;
    private File file;
    private HomeRecyclerViewAdapter.onHomeItemListener itemListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = root.findViewById(R.id.home_list);

        myAdapter = new HomeRecyclerViewAdapter(ITEMS, file, getActivity(), itemListener);
        // Set the adapter
        ...
        mSwipeRefreshLayout = root.findViewById(R.id.swiperefresh_home);
    ...
    public void onResume(){
        ...
        for(int i=0; i<ITEMS.size(); ++i){
            String curId = ITEMS.get(i).id;
            Boolean ifFav = readFavs(curId);
            if(ITEMS.get(i).ifFav != ifFav){
                ITEMS.get(i).ifFav = ifFav;
    ...
    private void initData() {
        String url =getString(R.string.homePageUrl);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            //myAdapter.notifyDataSetChanged();
                            LinearLayout progressbar_view = requireActivity().findViewById(R.id.progressbar_view);

                            if(progressbar_view.getVisibility() == View.VISIBLE){
                                progressbar_view.setVisibility(View.GONE);
                                RecyclerView homeView = requireActivity().findViewById(R.id.home_list);
    ...
    private void getWeather(){
        TextView cityTextView = requireActivity().findViewById(R.id.City);
        //System.out.println("Home weather loading...");
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        TextView tempView = requireActivity().findViewById(R.id.Temperature);
                        TextView weatherView = requireActivity().findViewById(R.id.Weather);
                        tempView.setText(temperature + "\u2103");
                        weatherView.setText(weather);
                        LinearLayout a = requireActivity().findViewById(R.id.weather_img);
                        switch (weather){
                            case "Clear":
                                a.setBackground(requireActivity().getDrawable(R.drawable.clear_weather));
                                break;
                            case "Clouds":
                                a.setBackground(requireActivity().getDrawable(R.drawable.cloudy_weather));
                                break;
                            case "Snow":
                                a.setBackground(requireActivity().getDrawable(R.drawable.snowy_weather));
                                break;
                            case "Rain":
                            case "Drizzle":
                                a.setBackground(requireActivity().getDrawable(R.drawable.rainy_weather));
                                break;
                            case "Thunderstorm":
                                a.setBackground(requireActivity().getDrawable(R.drawable.thunder_weather));
                                break;
                            default:
                                a.setBackground(requireActivity().getDrawable(R.drawable.sunny_weather));
                        }
    ...
    @Override
    public void onHomeItemClickListener(NewsItem item) {
    ...
    @Override
    public void onHomeItemLongClickListener(final NewsItem item) {
